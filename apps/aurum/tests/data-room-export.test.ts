...
const gastappDataRoomV2PeriodSummaries = (): GastappDataRoomV2PeriodSummary[] => ([
  {
    ...
    normalizedRowsAmountEur: 123.45,
    reconciliationDeltaEur: 0,
    dayToDayEur: 42.5,
    projectsEur: 30,
    tripsEur: 50.95,
    classifiedAmountEur: 123.45,
    unclassifiedAmountEur: 0,
...
const gastappDataRoomV2Rows = (): GastappDataRoomV2Row[] => ([
  {
    ...
    transactionOwner: 'Diego',
    transactionOwnerSource: 'creado_por_usuario_id',
    amountEur: 42.5,
    isCanonical: true,
    affectsAurum: true,
