...
const BLOCK_REASON_LABELS: Record<SimulationRunBlockedReason, string> = {
  ...
  aurum_snapshot_loading: 'Snapshot Aurum todavía cargando.',
  aurum_snapshot_missing: 'Falta snapshot Aurum aplicable.',
  aurum_snapshot_pending_apply: 'Snapshot Aurum válido pendiente de aplicar.',
  aurum_snapshot_invalid: 'Snapshot Aurum no aplicable; republica desde Aurum.',
  aurum_snapshot_permission_error: 'No hay permiso para leer el snapshot Aurum.',
  aurum_snapshot_network_error: 'No se pudo leer el snapshot Aurum por red.',
