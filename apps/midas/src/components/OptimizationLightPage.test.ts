...
assert(source.includes('evaluateOptimizerCanonicalGate'));
assert(source.includes('blockOptimizerRunIfNeeded'));
assert(source.includes('optimizerActionsBlocked'));
assert(source.includes('m8InputFingerprint'));
...
assert(source.includes('Evaluación MIDAS'));
assert(source.includes('Motivo ranking:'));
assert(source.includes('Alerta principal:'));
assert(source.includes('Lectura MIDAS'));
assert(source.includes('Por qué gana'));
assert(source.includes('Tradeoffs'));
assert(source.includes('Qué revisar'));
assert(source.includes('decisionBrief'));
...
assert(source.includes('Resultado preliminar. Sirve para explorar escenarios rápido; para obtener movimientos concretos usa Calcular recomendación completa.'));
assert(source.includes('Confirmar y calcular implementación'));
assert(source.includes('Mix actual'));
assert(source.includes('Mix recomendado'));
assert(source.includes('Mix implementable'));
assert(source.includes('a mover'));
assert(source.includes('requiere cambio de moneda'));
...
assert(source.includes('Por qué no llega a 100% RV'));
...
assert(source.includes('Plan implementable recomendado'));
assert(source.includes('Objetivo teórico'));
assert(source.includes('Mix alcanzable'));
assert(source.includes('Gap restante'));
assert(source.includes('Ver las'));
assert(source.includes('Ver diagnóstico de guardrails'));
...
assert(source.includes('Ver detalle del pipeline'));
...
assert(source.includes('Contingencia · No apta estándar MIDAS'));
assert(source.includes('Este plan implementa la mejor alternativa disponible bajo escenario de contingencia.'));
assert(source.includes('Confirmar y calcular implementación'));
