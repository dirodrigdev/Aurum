...
export const runM8 = (input: M8Input): M8RuntimeResult => {
  ...
  const result: M8RuntimeResult = {
    ...
    RuinYearP10: ruinMonthsYears.length ? percentile(ruinMonthsYears, 10) : Number.NaN,
    ...
    RuinYearP90: ruinMonthsYears.length ? percentile(ruinMonthsYears, 90) : Number.NaN,
