...
export const fromM8Output = (
  ...
  return {
    ...
    ruinTimingP10: output.RuinYearP10,
    ruinTimingP25: output.RuinYearP25,
    ruinTimingP75: output.RuinYearP75,
    ruinTimingP90: output.RuinYearP90,
    ...
    cutScenarioPct: output.CutScenarioPct,
    cutSeverityMean: output.CutSeverityMean,
    firstCutYearMedian: output.FirstCutYearMedian,
