...
export const SCENARIO_VARIANTS: ScenarioVariant[] = [
  ...
  },
  {
    ...
    rvGlobalAnnual:    0.0600,
    rfGlobalAnnual:    0.0240,
    rvChileAnnual:     0.0650,
    rfChileUFAnnual:   0.0070,
    rvGlobalVolAnnual: 0.1532 * 1.15,
    rfGlobalVolAnnual: 0.0368 * 1.15,
    rvChileVolAnnual:  0.1141 * 1.15,
    rfChileVolAnnual:  0.0237 * 1.15,
    correlationMatrix: [
      [1.00, 0.28, 0.76, 0.30],
      [0.28, 1.00, 0.40, 0.40],
      [0.76, 0.40, 1.00, 0.30],
    ...
    ipcChileAnnual:    0.0460,
    hipcEurAnnual: 0.0260,
    tcrealLT:          690,
    mrHalfLifeYears: 6.3,
  },
  {
    id: 'optimistic', label: 'Optimista',
    rvGlobalAnnual:    0.0800,
    rfGlobalAnnual:    0.0350,
    rvChileAnnual:     0.0850,
    rfChileUFAnnual:   0.0130,
    rvGlobalVolAnnual: 0.1532 * 0.90,
    rfGlobalVolAnnual: 0.0368 * 0.90,
    rvChileVolAnnual:  0.1141 * 0.90,
    rfChileVolAnnual:  0.0237 * 0.90,
    correlationMatrix: [
      [1.00, 0.05, 0.63, 0.18],
      [0.05, 1.00, 0.28, 0.28],
      [0.63, 0.28, 1.00, 0.18],
    ...
    ipcChileAnnual:    0.0320,
    hipcEurAnnual: 0.0190,
    tcrealLT:          600,
    mrHalfLifeYears: 6.3,
  },
];
